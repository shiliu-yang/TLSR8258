...
static const char auth_key_test[] = "J3z9nIZzLoHfcPq41nFwGOxNBzgoaFVy";
static const char device_id_test[] = "tuya0c2aed18cb19";
static const uint8_t mac_test[6] = {0x91,0x3A,0x68,0x4D,0x23,0xDC}; //The actual MAC address is : DC:23:4D:68:3A:91
